...
class Main :
    ...
    def update(self) :
        if px.btn(px.KEY_ESCAPE):
            exit()
        elif (px.btn(px.KEY_RIGHT) or px.btn(px.KEY_D)):
            self.warehouse.move_bot(">")
        elif (px.btn(px.KEY_LEFT)or px.btn(px.KEY_Q)) :
            self.warehouse.move_bot("<")
        elif (px.btn(px.KEY_UP) or px.btn(px.KEY_Z)) :
            self.warehouse.move_bot("^")
        elif (px.btn(px.KEY_DOWN) or px.btn(px.KEY_S)) :
            self.warehouse.move_bot("v")
